<%@ Page Title="" Language="C#" MasterPageFile="~/Mestra.Master" AutoEventWireup="true" CodeBehind="access.aspx.cs" Inherits="onlineStore.access" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="account-sign-in">
                            ...
                            <div action="#">
                                <div class="form__div">                                    
                                    <asp:TextBox ID="tb_loginemail" runat="server" class="form__input" placeholder=" "></asp:TextBox>
                                    <label for="" class="form__label">Email</label>
                                </div>
                                <div class="form__div mb-0">                        
                                    <asp:TextBox ID="tb_loginpass" runat="server" class="form__input" placeholder=" " TextMode="Password"></asp:TextBox>
                                ...
                                <div class="password-info d-flex align-items-center justify-content-between flex-wrap">
                                    ...
                                    <div class="password-info-right">
                                        <a href="forget-password.aspx">Forget Password</a>
                                    </div>
                                </div>                              
                                <asp:Button ID="btn_login" runat="server" Text="Sign in" class="btn bg-primary" OnClick="btn_login_Click" />
                                <br />
                                <asp:Label ID="lbl_loginwarnings" runat="server" Text="" ForeColor="#CC0000"></asp:Label>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="account-sign-up">
                            ...
                            <div action="#">
                                ...
                                <div class="form__div">
                                    <asp:TextBox ID="tb_email" runat="server" class="form__input" placeholder=" "></asp:TextBox>                   
                                    <label for="" class="form__label">Email</label>
                                </div>
                                <div class="form__div">
                                    <asp:TextBox ID="tb_password" runat="server" class="form__input" placeholder=" " TextMode="Password"></asp:TextBox>                             
                                    <label for="" class="form__label">Password</label>
                                </div>
                                <div class="form__div mb-0">
                                    <asp:TextBox ID="tb_repeatpassword" runat="server" class="form__input" placeholder=" " TextMode="Password"></asp:TextBox>                         
                                ...
                                <asp:Button ID="btn_signup" runat="server" Text="Sign Up" class="btn bg-primary" OnClick="btn_signup_Click"/>
                                <br />
                                <asp:Label ID="lbl_warnings" runat="server" Text="" ForeColor="#CC0000"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
                function showpass(check_box) {
                    var spass = document.getElementById("ContentPlaceHolder1_tb_password");
                    var spass2 = document.getElementById("ContentPlaceHolder1_tb_repeatpassword");
                    if (check_box.checked) {
                        spass.setAttribute("type", "text");
                        spass2.setAttribute("type", "text");
                    }
                    else {
                        spass.setAttribute("type", "password");
                        spass2.setAttribute("type", "password");
                    }
