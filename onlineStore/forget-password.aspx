<%@ Page Title="" Language="C#" MasterPageFile="~/Mestra.Master" AutoEventWireup="true" CodeBehind="forget-password.aspx.cs" Inherits="onlineStore.forget_password" %>
                    ...
                    <div class="col-md-12">
                        <div class="account-sign-in">
                            ...
                            <div action="#">
                                ...
                                <asp:Button ID="btn_resetpassword" runat="server" Text="Button" class="btn bg-primary" OnClick="btn_resetpassword_Click" />
                            </div>
