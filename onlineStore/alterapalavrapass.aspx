<%@ Page Title="" Language="C#" MasterPageFile="~/Mestra.Master" AutoEventWireup="true" CodeBehind="alterapalavrapass.aspx.cs" Inherits="onlineStore.alterapalavrapass" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="account-sign-in">
                            <h5 class="text-center modi-sm">Reset Password</h5>
                            <div action="#">
                                <div class="form__div">                                  
                                ...
                                <div class="form__div mb-0">
                                    ...
                                    <asp:TextBox ID="tb_confirmapassword" runat="server"  class="form__input" placeholder=" " TextMode="Password"></asp:TextBox>
                                    <label for="" class="form__label">Confirm Passwords</label>
                                </div>
                                <div class="password-info-show">
                                    <br />
                                </div>                               
                                <asp:Button ID="btn_resetpassword" runat="server" Text="Reset Password" class="btn bg-primary" OnClick="btn_resetpassword_Click"/>
                            </div>
